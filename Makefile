...
dockerfile: clean
	docker build -t img.conny.dev/ant31/mlservefast:v$(VERSION) .

dockerfile-canary: clean
	docker build -t img.conny.dev/ant31/mlservefast:canary .
	docker push img.conny.dev/ant31/mlservefast

dockerfile-push: dockerfile
	docker push img.conny.dev/ant31/mlservefast:v$(VERSION)
